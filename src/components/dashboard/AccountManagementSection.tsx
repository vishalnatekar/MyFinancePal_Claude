...
export function AccountManagementSection({
  ...
  const getConnectionStatusColor = (status: ManagedAccount['connectionStatus']) => {
    switch (status) {
      case 'active':
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm font-medium">
                        Balance: {formatCurrency(account.currentBalance, account.currency)}
                      </p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              associated transactions and balance history. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
