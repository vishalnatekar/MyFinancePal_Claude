...
export function AccountBreakdownCard({ accounts, loading }: AccountBreakdownCardProps) {
  return (
      ...
      <CardContent>
        {loading ? (
          ...
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm">Connect your first account to see your balance breakdown</p>
          </div>
        ) : (
          <div className="space-y-3">
            {accounts.map((account) => (
              ...
              >
                ...
                <div className="text-right space-y-1">
                  ...
                  >
                    {formatCurrency(account.current_balance, account.currency || 'GBP')}
                  </p>
                  {account.last_synced && (
                    <p className="text-xs text-gray-500">
                      {new Date(account.last_synced).toLocaleDateString('en-GB')}
                    </p>
                  )}
                </div>
              </div>
